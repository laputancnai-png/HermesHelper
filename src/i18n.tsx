...
const ZH = {
  ...
  channels: {
    ...
    wechat: {
      ...
      setupDesc: "配置微信网关，通过扫码登录",
      startSetup: "开始配置",
      setupRunning: "配置进行中，正在启动...",
      qrTitle: "请用微信扫描以下二维码",
      qrHint: "打开微信 → 扫一扫，扫描上方二维码",
      scanSuccess: "✅ 扫码成功，正在重启 Gateway...",
      setupWaitingTitle: "在终端运行配置向导",
      setupInstruction: "请在终端运行以下命令，选择 WeChat/Weixin，按提示扫码登录：",
      setupCommand: "hermes gateway setup",
      setupWaitingHint: "完成扫码登录后，点击下方按钮检测配置状态：",
      checkCredentials: "检测配置状态",
      checking: "检测中...",
      credentialNotFound: "未检测到微信账号，请先在终端完成扫码登录",
...
const EN: typeof ZH = {
  ...
  channels: {
    ...
    wechat: {
      ...
      setupDesc: "Set up WeChat gateway by scanning a QR code to log in",
      ...
      setupWaitingTitle: "Run Setup Wizard in Terminal",
      setupInstruction: "Run the command below in your terminal, select WeChat/Weixin, and scan the QR code to log in:",
      setupCommand: "hermes gateway setup",
      setupWaitingHint: "After completing QR login, click below to detect your account:",
      checkCredentials: "Check Setup Status",
      checking: "Checking...",
      credentialNotFound: "WeChat account not found — please complete the QR login in terminal first",
